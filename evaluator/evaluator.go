...
func evalProgram(program *ast.Program) object.IObject {
...
func evalIfExpression(ie *ast.IfExpression) object.IObject {
...
func evalBlockStatement(block *ast.BlockStatement) object.IObject {
	var result object.IObject
